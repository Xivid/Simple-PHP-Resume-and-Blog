...
?>信息聚合</title>
<link rel="stylesheet" type="text/css" href="<? echo $template_dir."styles.css" ?>">
</head>
<body>
...
<nav id="nav1">
	<span class="button1"<? if(current=="Index") echo' id="current"'?>><a href="index.php" class="nav1btn">Index</a></span>
	<span class="button1"<? if(current=="Post") echo' id="current"'?>><a href="post.php" class="nav1btn">Post New Entry</a></span>
</nav>
...
<div id="sidebar">
	<div class="widget" id="entrylist">
		...
		<div class="info"><?
			...
			while($row = mysql_fetch_array($query)){?><a href="show.php?id=<? echo $row['id'] ?>"><?echo $row['entry_title'] ?></a><br><?}?>
		</div>
	</div>
